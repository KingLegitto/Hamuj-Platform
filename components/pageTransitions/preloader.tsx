...
const Preloader = () => {
    ...
    return ( 
        <div className={`preloader fixed z-[99] bg-white w-screen h-dvh top-0 left-0`}>
            ...
            <div className="preloader-text absolute w-full text-center top-[calc(50%+5.5rem)] lg:top-[calc(50%+6rem)] left-1/2 -translate-x-1/2 "/>
        </div>
     );
}
