...
const NextStep = () => {
  return (
    <main className="relative w-full h-auto min-h-lvh bg-slate-50">
      ...
      <section className="mx-auto text-sm md:text-base flex flex-col justify-center items-center gap-y-10  rounded-3xl border-[2px] text-grade-3 border-[#e8e8e8] p-5 lg:p-16 w-[95%] md:w-[70%] h-[70vh] max-h-[500px] shadow-lg text-center my-[10rem]">
        <h2 className="font-normal text-lg md:text-xl text-grade-3">Your request has been placed successfully</h2>
        
        <span>To carry on with the consultations, follow the steps stated in the email sent to you.</span>

        <span>If any issues send an enquiry in the contact page or call +234 8061999995.</span>

        <span>Thank you for choosing Hamuj Homes.</span>
