...
const NotFound = () => {
    ...
    return (
        <section className="target mx-auto bg-white border-[5px] border-white text-sm md:text-base flex flex-col justify-center items-center gap-y-6 lg:gap-y-9 rounded-3xl text-grade-3 p-7 py-20 lg:p-16 w-[97%] md:w-[70%] lg:h-[70vh] max-h-[500px] shadow-[inset_5px_5px_0px_6px_#f3f3f3] md:shadow-[inset_9px_9px_0px_10px_#f3f3f3] text-center my-[5rem] md:my-[10rem]">
