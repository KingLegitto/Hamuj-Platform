const personalDetails: {
  ...
  { followUpTo: "How did you find us?", hidden: true, title: 'Please specify means', type: "text"},
...
const projectDetails: {
    ...
    { followUpTo: "Project type", hidden: true, title: "Please specify project type", type: "text" },
    ...
    { followUpTo: "Construction type", hidden: true, title: "Please specify construction type", type: "text" },
    ...
    { followUpTo: "Please select room(s)/areas included in project", hidden: true, title: "Please specify room", type: "text" },
    ...
    { followUpTo: "What styles would you like for this project?", hidden: true, title: "Please specify style", type: "text" },
    ...
    { followUpTo: "Which among these patterns do you prefer?", hidden: true, title: "Please specify pattern", type: "text" },
