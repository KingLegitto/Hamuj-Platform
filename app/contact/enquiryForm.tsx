  ...
  const [formIsVisible, setFormIsVisible] = useState(false)
    return ( 
      <>
        ...
        <motion.div initial={{y: '50%', opacity: 0}} animate={{y:0,opacity:1,transition:{delay:1, duration:0.3}}} whileTap={{scale: 0.8}} onClick={()=>{setFormIsVisible(true)}} className="lg:hidden fixed bottom-7 right-3 z-20 text-white bg-theme-2 rounded-full aspect-square px-4 py-3 flex justify-center items-center gap-x-2 shadow-lg">
